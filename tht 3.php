...
<div class="page-con-content">
	...
	<div class="page-con-container">
		<div class="page-in-container">
			...
			<div class='container-con-block darkmode-block'><br>
			<img src ="img/Запечёное/ty.png" width = "256" >
				<div class='container-con-wrapper'>
					...
					<div class='container-tx2-block darkmode-txt'>
						...
						<p class="download-desc">
							Курица - 1 шт. (около 1,8 кг)<br>
							Масло растительное (подсолнечное) - 1 ст. ложка<br>
							Соль - 0,5 ч. ложки (по вкусу)<br>
							Перец чёрный молотый - 0,5 ч. ложки (по вкусу)<br>
						</p>
					</div>
				</div>
			</div>
		...
		<div class="page-in-container">
			<div class='container-con-block darkmode-block'>
				<div class='container-con-wrapper'>
					...
					<div class='container-tx2-block darkmode-txt'>
						<p>
							1. Курицу вымыть, обсушить бумажным полотенцем. Духовку включить для разогрева до 230 градусов.<br>
<br>
							2. Смазать курицу маслом, посолить и поперчить.<br>
<br>
							3. Куриные ножки связать шпагатом или кулинарной нитью.<br>
<br>
							4. Уложить курицу в форму для запекания грудкой вверх. Крылышки сложить за спинку.<br>
<br>
							5. Поместить курицу в духовку. Запекать 25-30 минут при 230 градусах.<br>
<br>
							6. Затем духовку выключить и оставить там курицу ещё на 25-35 минут.<br>
<br>
							7. Достать запечённую курицу из духовки, переложить на блюдо. Оставить остывать на 20 минут и подавать к столу.<br>
<br>
